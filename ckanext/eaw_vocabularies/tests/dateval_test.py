...
class TestDateval(object):
    
    def test_split_explicit_range(self):
    ...
    def test_timestamp_pass(self):
        ...
        testts = ([x + 'T23:59:58.9997Z' for x in datetest_ok] +
                  ...
                  dateonly_ok)
        for t in testts:
                res = SolrDaterange.validate(t)

    def test_daterange_pass(self):
        rangetest_ok = ['2015 TO 2018', '* TO 2018-12-04', '*', '* TO *', 
                        '0900 TO *', '3012-12-31T12:01:03.765Z TO 3014',
                        '[* TO 2018-12-04]',
                        '[2015-12-31T23:54:12 TO 2018-01-01T00:00:00Z']
        for t in rangetest_ok:
            res = SolrDaterange.validate(t)

    def test_daterange_fail(self):
